...
public class FloodFillPilha {
    ...
    static void floodFill(int x, int y) {
        ...
        System.out.println("\u001B[0mDigite a cor que deseja mudar (RGB separados por espaço, ex: 255 255 255): ");
        int r = cm.nextInt();
        int g = cm.nextInt();
        int b = cm.nextInt();
        ...
        System.out.println("\u001B[0mDigite a nova cor desejada (RGB separados por espaço, ex: 255 0 0): ");
        r = nc.nextInt();
        g = nc.nextInt();
        b = nc.nextInt();
